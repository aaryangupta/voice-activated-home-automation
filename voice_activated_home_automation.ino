...
void loop() 
{
  ...
  ////////////////////////////////////////////////////////////////////
  {
    if(voice == "*on a"){           //Voice Command to ON Relay 01 
      digitalWrite(relay1, LOW);   //Relay 01 ON
      }
    else if(voice == "*on b"){      //Voice Command to ON Relay 02 
      digitalWrite(relay2, LOW);   //Relay 02 ON
      }
    else if(voice == "*on LED") {     //Voice Command to ON Relay 03
      digitalWrite(relay3, LOW);   //Relay 03 ON
    }
    else if(voice == "*on charger") {     //Voice Command to ON Relay 04 
      digitalWrite(relay4, LOW);   //Relay 04 ON
    }
    
    ////////////////////////////////////////////////////////////////////
    
    else if(voice == "*of a") {      //Voice Command to OFF Relay 01 
      digitalWrite(relay1, HIGH);   //Relay 01 OFF
    }
    else if(voice == "*of LED") {      //Voice Command to OFF Relay 02
      digitalWrite(relay3, HIGH);   //Relay 02 OFF
    }
    else if(voice == "*of b") {      //Voice Command to OFF Relay 02
      digitalWrite(relay2, HIGH);   //Relay 03 OFF
    }
    else if(voice == "*of charger") {      //Voice Command to OFF Relay 02
      digitalWrite(relay4, HIGH);   //Relay 04 OFF
    }
    
    ////////////////////////////////////////////////////////////////////
    
    else if(voice == "*all device on") {      //Voice Command to ON all Relays
      switchallon();                //All Relays ON
    }
    else if(voice == "*all device of") {      //Voice Command to OFF all Relays
